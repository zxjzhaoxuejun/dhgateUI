...
export default {
  ...
  methods: {
    ...
    onTransitionEnd(index) {
      const lastPage = this.temporaryData.currentPage === 0 ? this.cardList.length - 1 : this.temporaryData.currentPage - 1
    ...
    transform(index) {
      ...
      this.$nextTick(() => {
        ...
        const length = this.cardList.length
        const lastPage = currentPage === 0 ? this.cardList.length - 1 : currentPage - 1
        const visible = this.temporaryData.visible
